		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>SYNTAXX CHECKER</strong></h4>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/Roronoa_robot">CLICK HERE TO DM ME AND GIVE FEEDBACK </a> <br>
...
Swal.fire({ title: "SYNTAXX", text: "THANKS BOLDENA @Roronoa_robot ME :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
